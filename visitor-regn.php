	...
	$date=date("Y-m-d H:i:s",$tmp);		
		{
 		...
 		$to="keeeshore@gmail.com, mahesh@expoconsult.co.in , vimonisha@eth.net, vimonisha@vimonisha.com"; 
 		$subject = "Visitor Registration from Vimonisha";  
 		}
...
<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\">
  <tr>
   <td colspan=\"2\">Visitor Registration for Vimonisha Art Gallery</td>
  </tr>
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td width=\"26%\" height=\"28\" valign=\"top\"><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">Interest</font></td>
    <td width=\"74%\" height=\"28\"><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">$interest</font></td>
  </tr>
...
//exit;
   ...
   $success ="Your mail has been sucessfully send!";
}
}
    ...
    <div class="container">
			<h1> Exhibition Registration</h1>
				<div class='col-sm-8'>
						...
						<form id="form1" name="form1" method="post" action="" class="exbForm">
        <div class='row'>        
        <label>Name<span class="style6">*</span></label>
          <input class='form-control'  name="name" type="text" id="name" value="<?php echo $name ?>" />
        </div>
        
        <div class='row'>
           <label>Company Name</label>
           <input class='form-control'  name="coName" type="text" id="coName" value="<?php echo $coName ?>" />
        </div>
         <div class='row'>
           <label>Designation</label>
           <input class='form-control'  name="designation" type="text" id="designation" value="<?php echo $designation ?>" />
         </div>
         <div class='row'>
           <label>Tel No</label>
           <input class='form-control'  name="telNo" type="text" id="telNo" value="<?php echo $telNo ?>" /> 
            &nbsp; &nbsp;&nbsp;&nbsp; Mobile<span class="style6">*</span> :        
            <input class='form-control'  name="mobileNo" type="text" id="mobileNo" value="<?php echo $mobileNo ?>" />
         </div>
         <div class='row'>
           <label>Fax</label>
           <input class='form-control'  name="fax" type="text" id="fax" value="<?php echo $label ?>" />
&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; Email<span class="style6">*</span> :
<input class='form-control'  name="mailId" type="text" id="mailId" value="<?php echo $mailId ?>" />
         </div>
        <div class='row'>
           <label>Address<span class="style6">*</span></label>
           <textarea name="address" id="address" cols="45" rows="5"><?php echo $address ?>
</textarea>
        </div>
        <div class='row'>
          <label>City<span class="style6">*</span></label>
          <input class='form-control'  name="city" type="text" id="city" value="<?php echo $city ?>" />
        </div>
        <div class='row'>
          <label>PinCode<span class="style6">*</span></label>
          <input class='form-control'  name="pinCode" type="text" id="pinCode" value="<?php echo $pinCode ?>" />
        </div>
        <div class='row'>
          <label>Country<span class="style6">*</span></label>
        ...
        <div class='row'>
          ...
          <select name="interest" size="1" id="interest">
           <option value="Spring Sonata" selected="selected">Spring Sonata</option>
            <option value="Indian Summer 2010">Indian Summer 2010</option>
            <option value="Raksha Bandhan Show">Raksha Bandhan Show</option>
            <option value="Diwali Collection">Diwali Collection</option>           
           
          </select>
        </div>
        <div class='row'>
          <label>Feedback about the site</label>
          <textarea name="siteFeedback" id="siteFeedback" cols="45" rows="5" class="wide" ><?php echo $siteFeedback ?>
</textarea>
        </div>
        <div class='row'>
          <label style="width:580px; padding-bottom: 10px;">How did you come 
            to know about Vimonisha ?<span class="style6"></span><br />
          </label>
  ...
  <div class="clearer"></div>
        ...
        <div class='row'>
          ...
          <p>
            ...
            <br />
            <a href="#" onclick="document.getElementById('captcha').src = '../securimage/securimage_show.php?' + Math.random(); return false">Reload Image</a> | <?php echo $imgResponse ?> </p>
          <div class="clearer"></div>
        </div>
        <div class='row'>
          <label></label>
          <input class='form-control'  name="submitBtn" type="submit"  class="submitBtn" id="submitBtn" onclick="MM_validateForm('name','','R','telNo','','NisNum','mobile','','NisNum','mailId','','RisEmail','city','','R','pinCode','','NisNum','address','','R');return document.MM_returnValue" value="Submit"/>
        </div>
      </form>
